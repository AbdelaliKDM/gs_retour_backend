                        ...
                        <div class="p-3">
                            <div class="d-flex align-items-center mb-3">
                                <img src="https://placehold.co/100?text=User" alt="User"
                                    class="payer-image rounded-circle me-3" width="60" height="60">
                                <div>
                            ...
                            <div class="mt-3 pt-3 border-top">
                                <h6 class="mb-2 fw-semibold">{{ __('payment.wallet_information') }}</h6>
                                <div class="list-group list-group-flush">
                                    <div class="list-group-item px-0 py-2 d-flex justify-content-between border-0">
                                        <span class="text-muted">{{ __('payment.labels.balance') }}:</span>
                                        <span class="wallet-balance fw-semibold">-</span>
                                    </div>
                                    <div class="list-group-item px-0 py-2 d-flex justify-content-between border-0">
                                        <span class="text-muted">{{ __('payment.labels.charges') }}:</span>
                                        <span class="wallet-charges fw-semibold">-</span>
                                    </div>
                                </div>
                            </div>
                        </div>
