  ...
  <div class="modal-dialog modal-sm" role="document">
      <div class="modal-content">
          <div class="modal-header">
              <h4 class="fw-bold py-1 mb-1">{{ __("user.modals.update") }}</h4>
          ...
          <div class="modal-body">
              <form class="form-horizontal" onsubmit="event.preventDefault()" action="#"
                  ...
                  <div class="mb-3">
                    <label for="phone" class="form-label">{{ __("user.labels.phone") }}</label>
                    <input type="text" class="form-control" name="phone" placeholder="{{ __("user.placeholders.phone") }}">
                  </div>
