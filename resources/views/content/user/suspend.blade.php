<div class="modal fade" id="suspend-modal" aria-hidden="true">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="fw-bold py-1 mb-1">{{ __("user.modals.suspend") }}</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" onsubmit="event.preventDefault()" action="#" id="suspend-form">

          <input type="hidden" name="id">
          <input type="hidden" name="status" value="suspended">

          <div class="alert alert-danger mb-4">
            <h5 class="text-center">{{ __('user.suspend.confirmation') }}</h5>
            <p class="text-center mb-0">{{ __('user.suspend.warning') }}</p>
          </div>
          ...
          <div class="mb-3">
            <div class="form-check">
              ...
              <label class="form-check-label" for="confirmed">
                {{ __('user.suspend.confirm_checkbox') }}
              </label>
            </div>
          </div>
          ...
          <div class="d-flex justify-content-center gap-2">
            ...
            <button type="submit" id="suspend-submit" name="submit" class="btn btn-danger suspend-submit">
              {{ __('app.submit') }}
            </button>
          </div>
