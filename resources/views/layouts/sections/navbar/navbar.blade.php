            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li>
                    <a class="dropdown-item {{ Session::get('locale') == 'en' ? 'active' : '' }}"
                        ...
                        <span class="align-middle">{{ __('app.locales.english') }}</span>
                    </a>
                </li>
                <li>
                ...
                <a class="dropdown-item {{ Session::get('locale') == 'ar' ? 'active' : '' }}"
                    ...
                    <span class="align-middle">{{ __('app.locales.arabic') }}</span>
                </a>
        </li>
    </ul>
    </li>
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-styles">
            <li>
                <a class="dropdown-item {{ Session::get('theme') != 'dark' ? 'active' : '' }}"
                    ...
                    <span class="align-middle"><i class='bx bx-sun me-2'></i>{{ __('app.themes.light') }}</span>
                </a>
            </li>
            <li>
                <a class="dropdown-item {{ Session::get('theme') == 'dark' ? 'active' : '' }}"
                    href="{{ url('theme/dark') }}" data-theme="dark">
                    <span class="align-middle"><i class="bx bx-moon me-2"></i>{{ __('app.themes.dark') }}</span>
                </a>
            </li>
            {{-- <li>
    ...
    <li class="nav-item navbar-dropdown dropdown-user dropdown">
        <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
            <div class="avatar {{-- avatar-online --}}">
                ...
                <img src="{{ auth()->user()->image_url }}" class="w-px-40 h-auto rounded-circle">
            </div>
        </a>
        <ul class="dropdown-menu dropdown-menu-end">
            <li>
                <a class="dropdown-item" href="javascript:void(0);">
                    <div class="d-flex">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <small class="text-muted">{{ __('user.roles.' . auth()->user()->role) }}</small>
                        </div>
                    </div>
                </a>
            </li>
            ...
            <li>
                <a class="dropdown-item" href="{{ url('/account') }}">
                    <i class='bx bx-user me-2'></i>
                    <span class="align-middle">{{ __('app.account') }}</span>
                </a>
            </li>
            <li>
