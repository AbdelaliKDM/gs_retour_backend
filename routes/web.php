...
Route::group(['middleware' => ['auth']], function () {
  ...
  Route::post('/user/restore','App\Http\Controllers\UserController@restore')->name('user-restore');
  Route::post('/user/get','App\Http\Controllers\UserController@get')->name('user-get');
});
// layout
Route::group(['middleware' => ['auth']], function () {
...
// Temp
Route::get('/tldr', 'App\Http\Controllers\TLDRController@index')->name('tldr')->middleware('auth');
Route::post('/tldr/action', 'App\Http\Controllers\TLDRController@action')->middleware('auth');
