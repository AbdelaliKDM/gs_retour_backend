...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\projects\gs_retour_backend\public\storage' => 'string',
...
'filesystems.disks.upload.driver','filesystems.disks.upload.root','filesystems.disks.upload.url','filesystems.links.D:\\projects\\gs_retour_backend\\public\\storage','hashing.driver',
...
'permission.column_names.team_foreign_key','permission.register_permission_check_method','permission.register_octane_reset_listener','permission.teams','permission.use_passport_client_credentials',
...
'variables.templateName','view.paths','view.compiled','concurrency.default','firebase.default',
...
'firebase.projects.app.http_client_options.timeout','firebase.projects.app.http_client_options.guzzle_middlewares','livewire.class_namespace','livewire.view_path','livewire.layout',
...
'dashboard-analytics','pages-misc-error','pages-misc-under-maintenance','login','auth-register-basic','auth-reset-password-basic','auth-logout','user.user',
'user.info','user.list','user.','user.','user.',
'user.','category.index','category.list','category.','category.',
'category.','category.','category.','subcategory.index','subcategory.list',
'subcategory.','subcategory.','subcategory.','subcategory.','subcategory.',
'truck.type.index','truck.type.list','truck.type.','truck.type.','truck.type.',
'truck.type.','truck.type.','shipment.type.index','shipment.type.list','shipment.type.',
'shipment.type.','shipment.type.','shipment.type.','shipment.type.','payment.wallet',
'payment.invoice','payment.list','payment.','payment.','payment.',
'payment.info','notice.index','notice.list','notice.','notice.',
'notice.','notice.','notice.','documentation.',
'documentation.privacy_policy','documentation.about_app','documentation.terms_of_use','trip.pending','trip.ongoing',
'trip.paused','trip.canceled','trip.completed','trip.list','trip.',
'trip.info',);
        registerArgumentsSet('views', 
'_partials.macros','content.account.index','content.category.create','content.category.delete','content.category.index',
'content.category.update','content.documentation.index','content.notice.create','content.notice.delete','content.notice.index',
'content.notice.send','content.notice.update','content.payment.accept','content.payment.delete','content.payment.index',
'content.payment.info','content.payment.invoice-info','content.payment.reject','content.payment.wallet-info','content.settings.index',
'content.shipmentType.create','content.shipmentType.delete','content.shipmentType.index','content.shipmentType.update','content.subcategory.create',
'content.subcategory.delete','content.subcategory.index','content.subcategory.update','content.trip.delete','content.trip.index',
'content.trip.info','content.truckType.create','content.truckType.delete','content.truckType.index','content.truckType.update',
'content.user.accept','content.user.create','content.user.delete','content.user.index','content.user.info',
'content.user.reject','content.user.update','layouts.blankLayout','layouts.commonMaster','layouts.contentNavbarLayout',
'layouts.sections.footer.footer','layouts.sections.menu.verticalMenu','layouts.sections.navbar.navbar','layouts.sections.scripts','layouts.sections.scriptsIncludes',
'layouts.sections.styles','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui',
...
'template.auth-forgot-password-basic','template.auth-login-basic','template.auth-register-basic','template.dashboards-analytics','template.pages-misc-error',
'template.pages-misc-under-maintenance','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.default','vendor.pagination.semantic-ui',
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','app.dashboard','app.renters',
'app.drivers','app.users','app.inactive_users','app.suspended_users','app.categories',
'app.subcategories','app.trucks','app.truckTypes','app.shipmentTypes','app.trips',
'app.shipments','app.invoices','app.invoice_payments','app.wallet_payments','app.payments',
'app.notices','app.pending_trips','app.ongoing_trips','app.paused_trips','app.canceled_trips',
'app.completed_trips','app.documentation','app.privacy_policy','app.about_app','app.terms_of_use',
'app.delete_confirmation','app.delete_warning','app.delete_related_items','app.delete_confirm_checkbox','app.image.upload',
'app.image.reset','app.create','app.update','app.delete','app.cancel',
'app.close','app.download','app.save','app.send','app.change',
'app.submit','app.view','app.yes','app.no','app.currencies.dzd',
'app.settings','app.account','app.logout','app.signin','app.themes.light',
'app.themes.dark','app.locales.english','app.locales.french','app.locales.arabic','app.km',
'category.title','category.breadcrumb','category.browse','category.actions.create','category.actions.update',
'category.actions.delete','category.actions.restore','category.table.header','category.table.name_en','category.table.name_ar',
'category.table.name_fr','category.table.image','category.table.created_at','category.table.actions','category.modals.create',
'category.modals.update','category.modals.delete','category.modals.restore','category.labels.name_en','category.labels.name_ar',
'category.labels.name_fr','category.labels.image','category.placeholders.name_en','category.placeholders.name_ar','category.placeholders.name_fr',
'category.placeholders.image','dashboard.analytics_title','dashboard.drivers','dashboard.renters','dashboard.trips',
'dashboard.shipments','dashboard.wallet_payments','dashboard.invoice_payments','dashboard.view_all','dashboard.total_drivers',
'dashboard.total_renters','dashboard.total_trips','dashboard.total_shipments','dashboard.total_amount','dashboard.this_month',
'dashboard.compared_last_month','dashboard.progress_paid_percentage','dashboard.progress_active_percentage','dashboard.progress_completed_percentage','datatable.0',
'messages.profile.active.default.title','messages.profile.active.default.content','messages.profile.active.suspended.admin.title','messages.profile.active.suspended.admin.content','messages.profile.active.suspended.invoice.title',
'messages.profile.active.suspended.invoice.content','messages.profile.active.suspended.profile.title','messages.profile.active.suspended.profile.content','messages.profile.active.suspended.truck.title','messages.profile.active.suspended.truck.content',
'messages.profile.inactive.profile.title','messages.profile.inactive.profile.content','messages.profile.inactive.truck.title','messages.profile.inactive.truck.content','messages.profile.inactive.payment.title',
'messages.profile.inactive.payment.content','messages.review.title','messages.review.content','messages.trip.ongoing.title','messages.trip.ongoing.content',
'messages.trip.paused.title','messages.trip.paused.content','messages.trip.canceled.title','messages.trip.canceled.content','messages.trip.completed.title',
'messages.trip.completed.content','messages.shipment.shipped.title','messages.shipment.shipped.content','messages.shipment.delivered.title','messages.shipment.delivered.content',
'messages.order.created.title','messages.order.created.content','messages.order.accepted.title','messages.order.accepted.content','messages.order.rejected.title',
'messages.order.rejected.content','messages.payment.wallet.paid.title','messages.payment.wallet.paid.content','messages.payment.wallet.failed.title','messages.payment.wallet.failed.content',
'messages.payment.invoice.paid.title','messages.payment.invoice.paid.content','messages.payment.invoice.failed.title','messages.payment.invoice.failed.content','notice.title',
'notice.breadcrumb','notice.browse','notice.actions.create','notice.actions.edit','notice.actions.delete',
'notice.actions.send','notice.actions.view','notice.table.header','notice.table.title','notice.table.content',
'notice.table.priority','notice.table.created_at','notice.table.actions','notice.modals.create','notice.modals.update',
'notice.modals.delete','notice.modals.send','notice.labels.title_ar','notice.labels.title_en','notice.labels.title_fr',
'notice.labels.content_ar','notice.labels.content_en','notice.labels.content_fr','notice.labels.priority','notice.labels.recipient_type',
'notice.labels.delivery_method','notice.placeholders.title_ar','notice.placeholders.title_en','notice.placeholders.title_fr','notice.placeholders.content_ar',
'notice.placeholders.content_en','notice.placeholders.content_fr','notice.priority.optional','notice.priority.required','notice.recipients.all',
'notice.recipients.renters','notice.recipients.drivers','notice.delivery.app_only','notice.delivery.app_and_push','notice.hints.priority',
'notice.accept.confirmation','notice.accept.notice','notice.accept.confirm_checkbox','notice.reject.confirmation','notice.reject.warning',
'notice.reject.confirm_checkbox','notice.send.confirmation','notice.send.notice','notice.send.confirm_checkbox','payment.title.wallet',
'payment.title.invoice','payment.breadcrumb','payment.browse.wallet','payment.browse.invoice','payment.actions.info',
'payment.actions.delete','payment.actions.accept','payment.actions.reject','payment.table.header.wallet','payment.table.header.invoice',
'payment.table.user','payment.table.amount','payment.table.type','payment.table.status','payment.table.created_at',
'payment.table.actions','payment.table.id','payment.table.month','payment.types.wallet','payment.types.invoice',
'payment.statuses.pending','payment.statuses.failed','payment.statuses.paid','payment.statuses.unpaid','payment.statuses.unpayable',
'payment.payment_methods.wallet','payment.payment_methods.ccp','payment.payment_methods.baridi','payment.payment_methods.chargily','payment.modals.delete',
'payment.modals.accept','payment.modals.reject','payment.modals.info','payment.modals.wallet_info','payment.modals.invoice_info',
'payment.payer_information','payment.payment_information','payment.wallet_information','payment.invoice_information','payment.labels.name',
'payment.labels.phone','payment.labels.email','payment.labels.type','payment.labels.amount','payment.labels.status',
'payment.labels.paid_at','payment.labels.created_at','payment.labels.account_number','payment.labels.receipt','payment.labels.payment_method',
'payment.labels.balance','payment.labels.charges','payment.labels.total_amount','payment.labels.tax_amount','payment.labels.month',
'payment.accept.confirmation','payment.accept.notice','payment.accept.confirm_checkbox','payment.reject.confirmation','payment.reject.notice',
'payment.reject.confirm_checkbox','payment.wallet.wallet_information','payment.wallet.balance','payment.wallet.no_payments','payment.invoice.invoice_information',
'payment.invoice.total_due','payment.invoice.no_invoices','settings.version','settings.android','settings.android_version',
'settings.ios','settings.ios_version','settings.android_version_number','settings.android_build_number','settings.android_priority',
'settings.android_link','settings.ios_version_number','settings.ios_build_number','settings.ios_priority','settings.ios_link',
'settings.optional','settings.required','settings.sometimes','settings.missing','settings.contact_information',
'settings.whatsapp','settings.email','settings.facebook','settings.instagram','settings.financial_information',
'settings.ccp','settings.baridi','settings.chargily_pk','settings.chargily_sk','settings.chargily_mode',
'settings.test','settings.live','settings.payment_methods','settings.otp_enabled','settings.ccp_enabled',
'settings.cash_enabled','settings.baridi_enabled','settings.chargily_enabled','settings.alerts_settings','settings.pusher_instance_id',
'settings.pusher_primary_key','settings.calculation_settings','settings.price_per_km','settings.tax_ratio','settings.min_price',
'settings.max_price','shipment.shipments','shipment.id','shipment.renter','shipment.type',
'shipment.price','shipment.status','shipment.route','shipment.distance','shipment.created_at',
'shipment.actions','shipment.statuses.pending','shipment.statuses.shipped','shipment.statuses.delivered','shipmentType.title',
'shipmentType.breadcrumb','shipmentType.browse','shipmentType.actions.create','shipmentType.actions.update','shipmentType.actions.delete',
'shipmentType.actions.restore','shipmentType.table.header','shipmentType.table.name_en','shipmentType.table.name_ar','shipmentType.table.name_fr',
'shipmentType.table.created_at','shipmentType.table.actions','shipmentType.modals.create','shipmentType.modals.update','shipmentType.modals.delete',
'shipmentType.modals.restore','shipmentType.labels.name_en','shipmentType.labels.name_ar','shipmentType.labels.name_fr','shipmentType.placeholders.name_en',
'shipmentType.placeholders.name_ar','shipmentType.placeholders.name_fr','subcategory.title','subcategory.breadcrumb','subcategory.browse',
'subcategory.actions.create','subcategory.actions.update','subcategory.actions.delete','subcategory.actions.restore','subcategory.table.header',
'subcategory.table.name_en','subcategory.table.name_ar','subcategory.table.name_fr','subcategory.table.category','subcategory.table.image',
'subcategory.table.created_at','subcategory.table.actions','subcategory.modals.create','subcategory.modals.update','subcategory.modals.delete',
'subcategory.modals.restore','subcategory.labels.name_en','subcategory.labels.name_ar','subcategory.labels.name_fr','subcategory.labels.image',
'subcategory.labels.category','subcategory.placeholders.name_en','subcategory.placeholders.name_ar','subcategory.placeholders.name_fr','subcategory.placeholders.image',
'subcategory.placeholders.category','trip.title.pending','trip.title.ongoing','trip.title.paused','trip.title.canceled',
'trip.title.completed','trip.breadcrumb','trip.browse.pending','trip.browse.ongoing','trip.browse.paused',
'trip.browse.canceled','trip.browse.completed','trip.table.header.pending','trip.table.header.ongoing','trip.table.header.paused',
'trip.table.header.canceled','trip.table.header.completed','trip.table.id','trip.table.driver','trip.table.truck',
'trip.table.route','trip.table.distance','trip.table.status','trip.table.starts_at','trip.table.created_at',
'trip.table.actions','trip.statuses.pending','trip.statuses.ongoing','trip.statuses.paused','trip.statuses.canceled',
'trip.statuses.completed','trip.actions.info','trip.actions.delete','trip.modals.delete','trip.trip_information',
'trip.trip_details','trip.driver_information','trip.truck_information','trip.driver_and_truck_information','trip.view_driver_profile',
'trip.total_price','trip.truck_type','trip.shipment_count','trip.starting_wilaya','trip.arrival_wilaya',
'truckType.title','truckType.breadcrumb','truckType.browse','truckType.actions.create','truckType.actions.update',
'truckType.actions.delete','truckType.actions.restore','truckType.table.header','truckType.table.name_en','truckType.table.name_ar',
'truckType.table.name_fr','truckType.table.weight','truckType.table.capacity','truckType.table.subcategory','truckType.table.created_at',
'truckType.table.actions','truckType.modals.create','truckType.modals.update','truckType.modals.delete','truckType.modals.restore',
'truckType.labels.subcategory','truckType.labels.name_en','truckType.labels.name_ar','truckType.labels.name_fr','truckType.labels.weight',
'truckType.labels.capacity','truckType.placeholders.subcategory','truckType.placeholders.name_en','truckType.placeholders.name_ar','truckType.placeholders.name_fr',
'truckType.placeholders.weight','truckType.placeholders.capacity','user.title.renter','user.title.driver','user.title.inactive',
'user.title.suspended','user.breadcrumb','user.browse.renter','user.browse.driver','user.browse.inactive',
'user.browse.suspended','user.actions.create','user.actions.update','user.actions.delete','user.actions.restore',
'user.actions.accept','user.actions.reject','user.actions.info','user.table.header.renter','user.table.header.driver',
'user.table.header.inactive','user.table.header.suspended','user.table.name','user.table.email','user.table.phone',
'user.table.role','user.table.status','user.table.created_at','user.table.actions','user.modals.create',
'user.modals.update','user.modals.delete','user.modals.restore','user.modals.info','user.modals.accept',
'user.modals.reject','user.labels.name','user.labels.email','user.labels.password','user.labels.id',
'user.labels.phone','user.labels.created_at','user.labels.id_card','user.labels.id_card_selfie','user.placeholders.name',
'user.placeholders.email','user.roles.null','user.roles.renter','user.roles.driver','user.roles.admin',
'user.statuses.active','user.statuses.inactive','user.statuses.suspended','user.user_information','user.truck.title',
'user.truck.type','user.truck.serial_number','user.truck.gray_card','user.truck.driving_license','user.truck.insurance_certificate',
'user.truck.insurance_expiry_date','user.truck.inspection_certificate','user.truck.next_inspection_date','user.truck.affiliated_with_agency','user.truck.agency_document',
'user.truck.truck_information','user.truck.truck_type','user.truck.documents','user.truck.images','user.account_settings',
'user.account','user.profile_details','user.change_password','user.current_password','user.new_password',
'user.confirm_new_password','user.accept.confirmation','user.accept.notice','user.accept.confirm_checkbox','user.reject.confirmation',
'user.reject.warning','user.reject.reason','user.reject.confirm_checkbox','user.reasons.admin','user.reasons.profile',
'user.reasons.truck','user.reasons.invoice','user.documents','validation.custom.invalid_currency','validation.custom.invalid_amount',
'validation.custom.invalid_extension','messages.profile.active.inactive.profile.title','messages.profile.active.inactive.profile.content','messages.profile.active.inactive.truck.title','messages.profile.active.inactive.truck.content',
'messages.profile.active.inactive.payment.title','messages.profile.active.inactive.payment.content','truckType.table.id','truckType.table.image','truckType.related.trucks',
'messages.profile.active.suspended.inactive.profile.title','messages.profile.active.suspended.inactive.profile.content','messages.profile.active.suspended.inactive.truck.title','messages.profile.active.suspended.inactive.truck.content','messages.profile.active.suspended.inactive.payment.title',
'messages.profile.active.suspended.inactive.payment.content','truckType.labels.subcategory_id',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'ASSET_URL','LOG_CHANNEL','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION',
